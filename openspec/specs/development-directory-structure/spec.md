...
Provide a shared directory structure contract so contributors and AI coding agents put source changes, specifications, and project-specific guidance in the repository locations that form the shared source of truth.
