...
Define the local development environment contract so contributors and AI agents can bootstrap the project and run smoke tests without manual trial-and-error.
